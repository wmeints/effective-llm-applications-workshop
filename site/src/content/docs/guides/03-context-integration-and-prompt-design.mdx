...
### 🧪 Hands-on Lab: Integrating Context
...
> 📝 **Exercise**: Integrate the vector store into the shell application
    ...
    ITextEmbeddingGenerationService embeddingService)
{
    public async Task<string> AnswerAsync(string question)
    {
        ...
        var searchResponse = collection.SearchEmbeddingAsync(
...
## 📖 Running RAG in production - add different module for this???

- TODO: Think of data protection
- other stuff.
...
In this module, we explored three key aspects of building effective LLM applications:

1. **Semantic Search Implementation**
   - Learned how to integrate vector databases for context-aware responses
   - Implemented question embedding and vector store search
   - Combined search results into meaningful context

2. **Prompt Design**
   - Created structured prompt templates using Handlebars
   - Integrated context and questions into prompts
   - Optimized prompt parameters for better responses

3. **RAG as a Plugin**
   - Converted RAG functionality into a Semantic Kernel plugin
   - Implemented text search with vector store integration
   - Enabled automatic function calling through planning

Next steps:
- Consider data protection and security measures
- Explore production deployment strategies
- Experiment with different prompt templates and parameters
- Test with various types of questions and contexts
