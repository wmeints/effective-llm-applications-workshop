...
### 🧪 Hands-on Lab: Document Chunking
...
> 📝 **Exercise**: Read all files into memory in the C# application.
...
> 📝 **Exercise**: Create a basic text chunker that splits all text into chunks.
...
> 📝 **Exercise**: Enhance the chunker to support overlap.
...
> 📝 **Exercise**: Use Semantic Kernel's TextChunker to split text based on
> semantic boundaries.
...
<Aside>
RAG in production requires more sophisticated chunking strategies. 
...
### 🧪 Hands-on Lab: Generating Embeddings
...
> 📝 **Exercise**: Create a data model for the vector store.
...
> 📝 **Exercise**: Embed the chunks using semantic kernel.
...
3. Add an embedding model to the kernel.
...
### 🧪 Hands-on Lab: Storing Embeddings
...
> 📝 **Exercise**: Store the embeddings in the vector store.
