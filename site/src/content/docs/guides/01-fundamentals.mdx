...
Let's begin by understanding the basics of a large language model. You can [skip over
this section](#whats-semantic-kernel-and-why-should-you-use-it) if you already have
...
<Aside>
  **Despite what we told you, there is somewhat of a limit to what you can do
  with tools**  
  You shouldn't provide your agent with 100 tools because it
