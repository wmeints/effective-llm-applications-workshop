# Starter for module 2

This directory contains the starter solution for module 2 of the workshop.
You can use this as the starting point for the labs in the module "Document Processing & Embeddings"
